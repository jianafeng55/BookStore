            ...
            <div class="row">
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                        <h2 style="color: #1A0900">SIGN UP</h2>
                        <form  action="signup_html.php" method="POST">
                            ...
                            <button type="submit" name="submit" style="background-color: #1A0900;color: white" class="btn">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
